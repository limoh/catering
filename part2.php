...
<SCRIPT language=Javascript>
 ...
 <div class="row-top" style="margin-bottom: 20px;">
	<div class="main">
		<div class="wrapper">
			<h1><a href="">Jeecy catering <br>
			<span style="font-family: arial; font-size: 15px;">Jeecy catering online ordering system</span></a></h1>
			<a class="waves-effect waves-light btn" href="reservation.php">Back Home</a>
		</div>
	</div>
</div>
...
if($ewewe>=14){
	...
	Location: <br>
	<select name="loc">
	<option value=".10">Outside Jeecy</option>
	<option value=".00">Inside Jeecy</option>
	</select>
	<br>
	...
	<input type="submit" value="Order" style="margin-bottom: 13px; width: 298px;" />
	</form>
	<?php
	}
}
