...
$sadsdsd = $db->prepare("SELECT count(*) FROM reservation WHERE res_id= :a");
	...
	$wapakpak=$rowaas[0];
	if($wapakpak==0) {
	echo '<div style="text-align: center; margin-top: 100px;">Ordering ID Not Found<br><a href="index.php">Back</a></div>';
	}
	if($wapakpak>0){
?>
...
<strong style="font-size:14px">Jeecy catering </strong><br>
<strong> </strong><br>
ONLINE CATERING ORDERING,NAIROBI CITY<br>
Tel. No. 072-300-1853
</div><br><br>
<?php
include('connect.php');
