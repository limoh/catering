...
<head>
<title>
	Jeecy catering online ordering system
</title>
<!-- CSS Style -->
...
<body>
	<div id="top">
		<div class="logo">
<!-- 			<img src="img/cyshee.jpg"> <span style="float:right; color:#FFFFFF; font-weight:bold; display: inline-block; padding: 20px 0 0 20px;">Hello <?php echo $_SESSION['USERNAME'] ?></span>
 -->		</div>
	</div>
	<div class="container  clearfix">
		<div class="one-third1 column">
			<ul>
				...
				if($jhjh==1){
				?>
				<li><a class="active" href="adminaccount.php"><img alt=""><span>Maintenance</span></a></li>
				<?php
				}
				?>
	...
	<div id="footer">
		<div class="copyrights">&copy; Jeecy catering online ordering system</div>
	</div>
