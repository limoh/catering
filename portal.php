...
<strong style="font-size:18px;">Jeecy catering</strong><br>
<strong style="font-size:14px;"></strong><br>
JEECY CATERING ONLINE ORDERING SYSTEM, NAIROBI CITYy<br>
Tel. No. 072-300-1853<br />
<div style="text-align:center; color:#FFFF00; font-style:italic;">(Your Order is pending, you may check your ordering status after 24hrs. The management will call you or you may keep a copy of your ordering Id for verification.)</div>
</div><br><br>
<?php
include('connect.php');
$res=$_GET['res'];
